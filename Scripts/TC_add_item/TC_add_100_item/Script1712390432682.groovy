...
WebUI.click(findTestObject('add_item_object/item3'))

WebUI.setText(findTestObject('add_item_object/input_item_quantity'), '100')
...
WebUI.verifyTextPresent('iPhone 14 128GB | Chính hãng VN/A', false)
