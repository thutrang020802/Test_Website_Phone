...
WebUI.setText(findTestObject('change_password_object/input_old_password'), '12345678')

WebUI.setText(findTestObject('change_password_object/input_new_password'), '123456789')

WebUI.setText(findTestObject('change_password_object/input_confirm_password'), '123456789')

WebUI.click(findTestObject('change_password_object/button_cap_nhat_password'))

WebUI.verifyTextPresent('Thay Đổi Mật Khẩu Thành Công', false)
