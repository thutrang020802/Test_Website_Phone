...
WebUI.setText(findTestObject('register_object/input_username'), 'thutrang3')

WebUI.setText(findTestObject('register_object/input__email'), 'hihi150669@gmail.com')
...
WebUI.verifyTextPresent('Vui Lòng Nhập Mã Xác Thực', false)
